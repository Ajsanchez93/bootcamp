                    ...
                    <div>
                        ...
                        { post.user.id === auth.user.id &&
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    <button
                                        className='block w-full px-4 py-2 text-left text-sm leading-5 dark:text-white dark:hover:text-gray-700 hover:bg-gray-200 focus:bg-gray-100 transition duration-150 ease-in-out'
